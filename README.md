...
## Contents
* [rolldice](https://github.com/PacificGL/FiveM/tree/master/rolldice) - Roll x Dice with y Sides *(Stable)*
* [pgl_play](https://github.com/PacificGL/FiveM) - Roll Dice / Flip Coin / Rock, Paper, Scissors / etc. *(In Dev. Final Stages)*
